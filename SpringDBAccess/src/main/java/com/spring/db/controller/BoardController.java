...
public class BoardController {
	...
	//번호 제목 작성자 비고 네개의 열을 생성해 주세요. (맨 밑에 글쓰기 창으로가는 링크도 하나 달아주세요.)
	@GetMapping("/list")
	...
	public String searchList(@RequestParam("keyword") String keyword, Model model) {
		System.out.println("/board/searchList: GET 요청");
